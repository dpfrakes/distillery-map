...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Distillery.objects.bulk_create([
            ...
            Distillery(name='Auchtermuchty [de]', location='Auchtermuchty', region='Lowland', year_closed='1926'),
            Distillery(name='Auchtertool [de]', location='Auchtertool', region='Lowland', year_closed='1927', year_demolished='1985'),
