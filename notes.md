...
Google Map with KML layer of distilleries:
https://www.wanderingspirits.global/scotland-whisky-distillery-map/

High-res, interactive geographical map with "click-to-search" and tooltips (region, typ, status, active years):
https://www.malt-whisky-madness.com/maltmadness/whisky/map/Scotland/

Better Google map with clickable icons for each of many distilleries
https://flaviar.com/distilleries/scotch
